...
describe('Publish Reducer', function () {
    ...
    it('should append lower-level section structure', function () {
        [
            ...
            6: { id: 6, parent: 5, heading: 'S4', children: [7], contents: []},
            7: { id: 7, parent: 6, heading: 'S5', children: [], contents: []},
            8: { id: 8, parent: 5, heading: 'S6', children: [], contents: [{id: 9, text: 'P3'}]},
            10: { id: 10, parent: 0, heading: 'S7', children: [], contents: []},
            nextId: 11,
            section: 10,
            index: 0
        });
    ...
    it('should append section when inserting higher-level section before it', function () {
        [
            ...
            4: { id: 4, parent: 0, heading: 'IS', children: [], contents: []},
            nextId: 5,
            section: 4,
            index: 0
        });
    ...
    it('should append section (with paragraph) when inserting higher-level section before it', function () {
        [
            ...
            5: { id: 5, parent: 0, heading: 'IS', children: [], contents: []},
            nextId: 6,
            section: 5,
            index: 0
        });
    ...
    it('should append section (with subsection) when inserting higher-level section before it', function () {
        [
            ...
            4: { id: 4, parent: 3, heading: 'S4', children: [], contents: []},
            nextId: 5,
            section: 2,
            index: 0
        }).to({
    ...
    it('should collapse following sections on higher-level section insertion', function () {
       [
           ...
           0: { id: 0, heading: 'S0', children: [1, 2, 6, 5, 4], contents: []},
           ...
           5: { id: 5, parent: 0, heading: 'S5', children: [], contents: []},
           6: { id: 6, parent: 0, heading: 'IS', children: [], contents: []},
           nextId: 7,
           section: 6,
           index: 0
       });
    ...
    it('should collapse following sections with paragraphs on higher-level section insertion', function () {
        [
            ...
            5: { id: 5, parent: 3, heading: 'S5', children: [], contents: [{id: 11, text: 'P11'}]},
            nextId: 12,
            section: 3,
            index: 1
        }).to({
            0: { id: 0, heading: 'S0', children: [1, 2, 12, 5, 4], contents: []},
            1: { id: 1, parent: 0, heading: 'S1', children: [3], contents: [{id: 6, text: 'P6'}]},
            2: { id: 2, parent: 0, heading: 'S2', children: [], contents: [{id: 7, text: 'P7'}]},
            3: { id: 3, parent: 1, heading: 'S3', children: [], contents: [{id: 8, text: 'P8'}]},
            4: { id: 4, parent: 0, heading: 'S4', children: [], contents: [{id: 10, text: 'P10'}]},
            5: { id: 5, parent: 0, heading: 'S5', children: [], contents: [{id: 11, text: 'P11'}]},
            12: { id: 12, parent: 0, heading: 'IS', children: [], contents: [{id: 9, text: 'P9'}]},
            nextId: 13,
            section: 12,
            index: 0
        });
